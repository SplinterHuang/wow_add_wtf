...
EA_SPELL_POWER_COMBO_POINT = Enum.PowerType.ComboPoints or 4;	-- 連擊點數（盜賊、貓D）
...
EA_SPELL_POWER_INSANITY = 13;			-- 瘋狂（暗牧）
...
EA_SPELL_POWER_FURY = 17;				-- 惡魔獵人(魔怒)
EA_SPELL_POWER_PAIN = 18;				-- 惡魔獵人(魔痛)
