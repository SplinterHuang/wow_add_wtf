...
local function GetInspectTalentInfo(unit)
	...
	name1, _, _, _, point1 = GetTalentTabInfo(1, isInspect,false,talentGroup)
	name2, _, _, _, point2 = GetTalentTabInfo(2, isInspect,false,talentGroup)
	name3, _, _, _, point3 = GetTalentTabInfo(3, isInspect,false,talentGroup)
