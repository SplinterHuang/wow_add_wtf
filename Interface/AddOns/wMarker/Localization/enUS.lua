...
["Blips"] = "Blips",
["Icons"] = "Icons",
["Lock frames together"] = "Lock frames together",
["Countdown time"] = "Countdown time",
["Clear all marks at the same time"] = "Clear all marks at the same time",
["Start a countdown timer by right-clicking the Ready Check button"] = "Start a countdown timer by right-clicking the Ready Check button",
