...
DBM.DefaultOptions = {
	...
	PullVoice = "Corsica",
	ChosenVoicePack2 = (GetLocale() == "enUS" or GetLocale() == "zhCN" or GetLocale() == "zhTW") and "Yike" or "None",	--bf@178.com
	VPReplacesAnnounce = true,
	VPReplacesSADefault = true,
	EventSoundVictory2 = "None",		--bf@178.com
	EventSoundWipe = "None",
...
do
	...
	function DBM:LoadGUI()
		...
		if self.NewerVersion and showConstantReminder >= 1 then
			-- AddMsg(self, L.UPDATEREMINDER_HEADER:format(self.NewerVersion, showRealDate(self.HighestRelease)))	bf@178.com
		end
