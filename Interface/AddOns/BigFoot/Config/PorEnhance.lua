			...
			ModManagement_RegisterCheckBox(
				...
				function(arg)
					if arg == 1 then
						...
						if BigFoot_IsAddOnLoaded("MobHealth") then
							BigFoot_SetModVariable("MobHealth", "MobHealthEnable", 0);
							MobHealth_Toggle();
						end
						if BigFoot_IsAddOnLoaded("TUnitFrame") then
							BigFoot_SetModVariable("BuffMaster", "AdjustBuffSize", 0);
						end
				...
				function(arg)
					if (arg == 1) then
						...
						if (BigFoot_IsAddOnLoaded("TUnitFrame") and BigFoot_IsAddOnLoadedFromBigFoot("EasyFrames")) then
							BigFoot_SetModVariable("BuffMaster", "AdjustBuffSize", 0);
						end
						ModManagement_Refresh();
					end
